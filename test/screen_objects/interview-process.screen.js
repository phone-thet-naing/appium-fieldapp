class InterviewProcess {
    get downArrow() {
        return $(`//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/ivArrow"]`)
    }
    get mobileRadioBtn() {
    ...
    get houseNoInputBox() {
        return $(`//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/etHouseNo"]`)
    }
    get streetNoInputBox() {
        return $(`//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/etStreetNo"]`)
    }
    get nextBtn() {
        return $(`//*[@text="NEXT"]`)
    }
    ...
    async chooseOption(max, min) {
        return $(`/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.TextView[${Math.floor(Math.random() * (max - min) + min)}]`).click()
    }
    ...
    async clickRadioBtn(max, min) {
        $(`/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.FrameLayout[4]/android.widget.LinearLayout/android.widget.RadioGroup/android.widget.RadioButton[${Math.floor(Math.random() * (max - min) + min)}]`).click()
    }
    ...
    async setLength(index, length) {
        return $(`/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.FrameLayout[${index}]/android.widget.LinearLayout/android.widget.EditText`).setValue(length)
    }
    ...
    get businessTypeDropDown() {
        return $(`//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/autoCompleteTv"]`)
    }
    get businessDetail() {
    ...
    async setBusinessExpense(index, amount) {
        return $(`/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.FrameLayout[${index}]/android.widget.LinearLayout/android.widget.EditText`).setValue(amount)
    }
    ...
    get spinnerTownshipCode() {
        return $(`//*[@resource-id='com.hanamicrofinance.FieldApp.uat:id/spinnerNrcTownShipCode']`)
    }
    get spinnerNrcType() {
        return $(`//*[@resource-id='com.hanamicrofinance.FieldApp.uat:id/spinnerNrcType']`)
    }
    get etNrcNo() {

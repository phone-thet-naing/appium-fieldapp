...
class MakeAppointmentHelper {
    ...
    async fillAppointmentData(loanType) {
        ...
        const loanTypeDropdown = await driver.waitUntil(async () => {
            const dropdownList = await $$('//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/ivDropDown"]');
        ...
        const randomDistrict = await driver.waitUntil(async () => {
            const districtList = await $$('//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/tvSpinnerItem"]')
        ...
        const randomTown = await driver.waitUntil(async () => {
            const townList = await $$('//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/tvSpinnerItem"]')
        ...
        const randomLeaf = await driver.waitUntil(async () => {
            const leafList = await $$('//*[@resource-id="com.hanamicrofinance.FieldApp.uat:id/tvSpinnerItem"]')
    ...
    async addMember(totalClients) {
        ...
        for (let i = 0; i < totalClients; i++) {
            const selectedMember = await driver.waitUntil(async () => {
                ...
                return radioList[Math.floor(Math.random() * (radioList.length))]
            })
